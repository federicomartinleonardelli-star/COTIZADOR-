...
## Segundo arreglo (se quedaba "pegado" al tocar Cotizar desde Configuración)

Si estabas scrolleado bien abajo dentro de Configuración (por ejemplo viendo la lista
de campañas) y tocabas "COTIZAR" en el menú de arriba, la pantalla cambiaba por detrás
pero el scroll se quedaba en la misma posición — como Configuración es una página larga
y Cotizar es más corta, terminabas mirando un espacio en blanco y parecía que no había
pasado nada. Ahora, al cambiar de pestaña (Cotizar, BNA, Cheques o Configuración), la
app siempre vuelve el scroll arriba del todo.
